...
from sharing.util.util import read_yaml_file,save_object,save_numpy_array_data,load_data
...
class DataTransformation:
    ...
    def initiate_data_transformation(self)->DataTransformationArtifact:
        ...
        # we are going to passout transformed_train_file_path and test as well to model trainer
